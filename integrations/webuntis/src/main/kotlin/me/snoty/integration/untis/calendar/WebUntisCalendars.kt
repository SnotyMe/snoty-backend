...
import me.snoty.integration.untis.WebUntisStateCollection
...
class WebUntisCalendarBuilder(webUntisStateCollection: WebUntisStateCollection) : ICalBuilder<Int>(webUntisStateCollection) {
...
fun Route.iCalRoutes(webUntisStateCollection: WebUntisStateCollection) {
	calendarRoutes(
		WebUntisIntegration.INTEGRATION_NAME,
		UntisExam.TYPE,
		WebUntisCalendarBuilder(webUntisStateCollection)
	)
}
